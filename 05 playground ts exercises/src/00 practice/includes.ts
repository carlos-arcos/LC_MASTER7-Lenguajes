...
function includes(array, value) {
  ...
  function includes2(array, value) {
      return Boolean(array.find(item => value === item));
  }

  console.log(includes2([1, 2, 3], 3)) // true
  console.log(includes2([1, 2, 3], 0)) // false
  
  // Esta opción me gusta más que la de find
  function includes3(array, value) {
      return array.some(item => value == item);
  }

  console.log(includes3([1, 2, 3], 3)) // true
  console.log(includes3([1, 2, 3], 0)) // false



console.log("---------------- Fin: includes ----------------");